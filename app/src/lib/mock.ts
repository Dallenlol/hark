...
const settings: Settings = {
  ...
  summary_enabled: true, default_template_id: "general", share_port: 47123, calendar_sources: [], calendar_refresh_min: 15, webhook_url: "", webhook_enabled: false, auto_update_check: true,
};
